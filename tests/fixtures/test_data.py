...
SAMPLE_CONTENT_ITEMS = [
    ...
    ContentItem(text="Salesforce is a cloud-based CRM platform that helps businesses manage customer relationships.", element_type="text"),
    ContentItem(text="Key Features", element_type="heading", level=2),
    ContentItem(text="Lead management\nOpportunity tracking\nCustomer service", element_type="list"),
    ContentItem(text="public class Account {\n    public String name;\n}", element_type="code"),
    ContentItem(text="Getting Started", element_type="heading", level=2),
    ContentItem(text="To begin using Salesforce, you'll need to understand the basic concepts and navigation.", element_type="text")
]
...
SAMPLE_LINKS = [
    ...
    {"text": "Trailhead Learning Path", "url": "https://trailhead.salesforce.com/content/learn/trails/force_com_admin_beginner"},
    {"text": "Developer Documentation", "url": "https://developer.salesforce.com/docs"},
    {"text": "Community Forums", "url": "https://trailhead.salesforce.com/trailblazer-community"}
]
...
SAMPLE_MODULE_LESSONS = [
    {"title": "Get Started with the Platform", "url": "https://trailhead.salesforce.com/content/learn/modules/starting_force_com/starting_force_com_intro"},
    {"title": "Understand Custom Objects", "url": "https://trailhead.salesforce.com/content/learn/modules/starting_force_com/starting_force_com_understanding_custom_objects"},
    {"title": "Explore the AppExchange", "url": "https://trailhead.salesforce.com/content/learn/modules/starting_force_com/starting_force_com_understanding_appexchange"},
    {"title": "Knowledge Check", "url": "https://trailhead.salesforce.com/content/learn/modules/starting_force_com/starting_force_com_quiz"}
]
...
SAMPLE_MODULE_CONTENT = ModuleContent(
    ...
    difficulty="Beginner",
    prerequisites=["Basic understanding of CRM concepts", "Familiarity with web applications"]
)

# Sample trail modules
SAMPLE_TRAIL_MODULES = [
    {"title": "Salesforce Platform Basics", "url": "https://trailhead.salesforce.com/content/learn/modules/starting_force_com"},
    {"title": "Data Modeling", "url": "https://trailhead.salesforce.com/content/learn/modules/data_modeling"},
    {"title": "Lightning Experience Basics", "url": "https://trailhead.salesforce.com/content/learn/modules/lex_migration_introduction"},
    {"title": "User Management", "url": "https://trailhead.salesforce.com/content/learn/modules/lex_implementation_user_setup_mgmt"}
]
    ...
    'lessons': [
        {
            ...
            'url': 'https://trailhead.salesforce.com/content/learn/modules/starting_force_com/starting_force_com_intro',
            'content': [
                {'text': 'Introduction to Salesforce', 'element_type': 'heading', 'url': None, 'level': 1},
                {'text': 'Salesforce is a cloud-based CRM platform that helps businesses manage customer relationships.', 'element_type': 'text', 'url': None, 'level': None}
            ],
            'learning_objectives': SAMPLE_LEARNING_OBJECTIVES,
            'instructions': SAMPLE_INSTRUCTIONS,
            'links': SAMPLE_LINKS,
