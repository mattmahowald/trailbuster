...
from salesforce.parse import ModuleContent, LessonContent, ContentItem
...
class TestTrailheadCrawlerIntegration(unittest.TestCase):
    ...
    def _setup_mock_page_for_module(self):
        ...
        mock_module = ModuleContent(
            ...
            lessons=[
                {"title": "Lesson 1", "url": "https://trailhead.salesforce.com/content/learn/modules/test_module/lesson1"},
                {"title": "Lesson 2", "url": "https://trailhead.salesforce.com/content/learn/modules/test_module/lesson2"}
            ],
    ...
    def test_crawl_module_success(self, mock_parse_lesson, mock_parse_module):
        ...
        self.mock_page.url = "https://trailhead.salesforce.com/content/learn/modules/test_module"
        
        # Test crawling
        module_url = "https://trailhead.salesforce.com/content/learn/modules/test_module"
    ...
    def test_crawl_module_failure(self, mock_parse_module):
        ...
        with open(progress_file, 'r') as f:
            progress = json.load(f)
        self.assertIn(module_url, progress['failed_urls'])
    ...
    def test_crawl_module_already_visited(self):
        ...
        with patch.object(self.crawler, '_load_existing_data', return_value=existing_data):
            result = self.crawler.crawl_module(module_url, self.mock_auth)
    ...
    def test_crawl_trail_success(self):
        ...
        mock_trail_info = {
            ...
            'modules': [
                {'title': 'Module 1', 'url': 'https://trailhead.salesforce.com/content/learn/modules/module1'},
                {'title': 'Module 2', 'url': 'https://trailhead.salesforce.com/content/learn/modules/module2'}
            ]
        }
        ...
        with patch.object(self.crawler, '_extract_trail_info', return_value=mock_trail_info), \
    ...
    def test_crawl_trail_failure(self):
        ...
        with patch.object(self.crawler, '_extract_trail_info', side_effect=Exception("Trail parsing failed")):
            trail_url = "https://trailhead.salesforce.com/trails/test_trail"
            result = self.crawler.crawl_trail(trail_url, self.mock_auth)
    ...
    def test_crawl_urls_from_file_success(self):
        ...
        with patch.object(self.crawler, 'crawl_module', return_value=mock_module_result), \
        ...
        self.assertIn("https://trailhead.salesforce.com/content/learn/modules/module1", result)
        self.assertIn("https://trailhead.salesforce.com/trails/trail1", result)
        self.assertIn("https://trailhead.salesforce.com/content/learn/modules/module2", result)
    ...
    def test_crawl_urls_from_file_not_found(self):
        ...
        result = self.crawler.crawl_urls_from_file(str(non_existent_file), self.mock_auth)
    ...
    def test_extract_trail_info(self):
        ...
        mock_desc_element.text_content.return_value = "Test trail description for testing"
        
        mock_module_element = Mock()
        mock_module_element.get_attribute.return_value = "/content/learn/modules/test_module"
        ...
        self.assertEqual(trail_info['description'], "Test trail description for testing")
        self.assertEqual(len(trail_info['modules']), 1)
        self.assertEqual(trail_info['modules'][0]['title'], "Test Module")
        self.assertEqual(trail_info['modules'][0]['url'], "https://trailhead.salesforce.com/content/learn/modules/test_module")
    ...
    def _mock_locator_for_trail_extraction(self, title_elem, desc_elem, module_elem):
        ...
        def locator_side_effect(selector):
            ...
            elif selector in ["[data-testid='trail-description']", ".trail-description", ".description", "p:first-of-type"]:
                mock_locator.first = desc_elem
            elif selector in [".trail-modules a", ".modules-list a", ".module-list a", "[data-testid='module-link']"]:
    ...
    def test_load_existing_module_data(self):
        ...
        # Test loading
        result = self.crawler._load_existing_data("https://trailhead.salesforce.com/content/learn/modules/test_module")
    ...
    def test_load_existing_lesson_data(self):
        ...
        # Test loading
        result = self.crawler._load_existing_lesson_data("https://trailhead.salesforce.com/content/learn/modules/test_module/lesson1")
...
class TestCrawlerFileOperations(unittest.TestCase):
    ...
    def test_save_module_data(self):
        ...
        module_url = "https://trailhead.salesforce.com/content/learn/modules/test-module"
        self.crawler._save_module_data(module_url, test_data)
        
        # Verify file was created
        expected_file = Path(self.temp_dir) / "modules" / "_content_learn_modules_test_module.json"
    ...
    def test_directory_creation(self):
        ...
        self.crawler._save_trail_data("https://example.com/trail", {'trail': {'title': 'Test'}})
